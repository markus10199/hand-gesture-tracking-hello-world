...
class HandDetector:
    ...
    def __init__(self, a_max_num_hands=2, a_min_detection_confidence=0.5) -> None:
        """Constuctor
        ...
        self.capture.set(3, 1280) # the width of the window
        self.capture.set(4, 720) # height of the window
